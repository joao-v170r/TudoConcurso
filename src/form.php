...
<div class="testbox">
  <form class="pageForm" action="/">
    ...
    <div class="question-answer">
      <label><input class="pageInput" type="radio" value="none" name="questao3" /> Norte</label>
      <label><input class="pageInput" type="radio" value="none" name="questao3" /> Nordeste</label>
      <label><input class="pageInput" type="radio" value="none" name="questao3" /> Sul</label>
      <label><input class="pageInput" type="radio" value="none" name="questao3" /> Sudeste</label>
      <label><input class="pageInput" type="radio" value="none" name="questao3" /> Centro-oeste</label>
    </div>
    <p class="question">Qual é o seu nível de escolaridade?</p>
    <div class="question-answer">
      <label><input class="pageInput" type="radio" value="none" name="questao4" /> Ensino médio completo</label>
      <label><input class="pageInput" type="radio" value="none" name="questao4" /> Ensino superior incompleto</label>
      <label><input class="pageInput" type="radio" value="none" name="questao4" /> Ensino superior completo</label>
      <label><input class="pageInput" type="radio" value="none" name="questao4" /> Pós graduação em andamento</label>
      <label><input class="pageInput" type="radio" value="none" name="questao4" /> Pós graduado</label>
    </div>
    <p class="question">Por qual área do conhecimento você se interessa mais?</p>
    <div class="question-answer">
      <label><input class="pageInput" type="radio" value="none" name="questao5" /> Ciências Exatas</label>
      <label><input class="pageInput" type="radio" value="none" name="questao5" /> Ciências Humanas</label>
      <label><input class="pageInput" type="radio" value="none" name="questao5" /> Direito</label>
      <label><input class="pageInput" type="radio" value="none" name="questao5" /> Ciências Biológicas</label>
      <label><input class="pageInput" type="radio" value="none" name="questao5" /> Engenharia</label>
    </div>
    ...
    <div class="question-answer">
      <label><input class="pageInput" type="radio" value="none" name="questao7" /> R$1.000 - R$2.000</label>
      <label><input class="pageInput" type="radio" value="none" name="questao7" /> R$2.000 - R$5.000</label>
      <label><input class="pageInput" type="radio" value="none" name="questao7" /> R$5.000 - R$8.000</label>
      <label><input class="pageInput" type="radio" value="none" name="questao7" /> R$8.000 - R$11.000</label>
      <label><input class="pageInput" type="radio" value="none" name="questao7" /> Mais que R$ 11.000</label>
    </div>
